  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-12 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0 relative">
        ...
        <nav className="flex items-center justify-center gap-5 sm:gap-7 text-[10px] sm:text-[11px] font-mono tracking-widest font-extrabold md:mx-auto" id="nav-links">
          <button
            onClick={() => {
              setActiveView("home");
              window.scrollTo({ top: 0, behavior: "smooth" });
        ...
        <button
          ...
          className="flex items-center justify-center px-4 py-1.5 rounded-xl text-[10px] font-mono font-extrabold uppercase tracking-widest text-[#1A0533] bg-[#FFD54F] hover:bg-[#FFD54F]/90 transition-all active:scale-95 cursor-pointer md:absolute md:right-6 lg:right-12 shadow-lg shadow-[#FFD54F]/10 hover:shadow-[#FFD54F]/20"
