...
export default function App() {
  ...
  const getBackgroundStyle = () => {
    ...
    switch (activeView) {
      case "home":
        // Beautiful lighter blended cosmic purple that matches and smoothly transitions from the Hero background
        return "linear-gradient(to bottom, #461c8a 0px, #461c8a 100vh, #1c0738 140vh, #090214 100%)";
      case "heritage":
